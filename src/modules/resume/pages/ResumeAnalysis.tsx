  ...
  return (
    <div key={componentKey} className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {analysis.category_scores?.map((category: any) => (
            ...
            {userResumes.map((resume) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  >
                    {getScoreIcon(resume.ats_score || 0)}
                    <span className="ml-1">{resume.ats_score || 0}/100</span>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs text-gray-600">
                    ATS Score:{" "}
                    {(resume.ats_score || 0) >= 80
                      ? "Excellent"
                      : (resume.ats_score || 0) >= 60
                      ? "Good"
                      : "Needs Improvement"}
                  </p>
                </div>
