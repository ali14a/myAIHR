...
class LinkedInAuthService {
  ...
  constructor() {
    ...
    if (!this.clientId) {
      console.warn('LinkedIn Client ID not found. Please set VITE_LINKEDIN_CLIENT_ID in your environment variables.');
    }
  }
  ...
  isConfigured(): boolean {
    return !!this.clientId && this.clientId !== 'REPLACE_WITH_YOUR_ACTUAL_LINKEDIN_CLIENT_ID';
  }
